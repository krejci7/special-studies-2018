...
# Radically Queer has 4 pages as of Feb 15 2018
for i in range(1,5):

    d = feedparser.parse('https://radicallyqueer.wordpress.com/category/gender/trans/feed/?paged='+str(i))
    ...
    for e in d.entries:
        ...
        file = open("RawPosts/RadQ/" + str(j) + ".txt", "w")
