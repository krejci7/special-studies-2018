...
# Darlene Tando, LCSW has 6 pages as of Feb 15 2018
for i in range(1,7):

    d = feedparser.parse('https://darlenetandogenderblog.com/feed/?paged='+str(i))
    ...
    for e in d.entries:
        ...
        file = open("RawPosts/DTando/" + str(j) + ".txt", "w")
